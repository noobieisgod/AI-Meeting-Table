...
require_contains("${provider_source}" "response.deliveryOutcome != ProviderDeliveryOutcome::DefiniteFailure" "typed automatic retry gate")
...
file(READ "${SOURCE_DIR}/apps/android/android/src/com/aimeetingtable/mobile/FileBridge.java" file_bridge_source)
file(READ "${SOURCE_DIR}/apps/android/android/src/com/aimeetingtable/mobile/AttachmentContentProvider.java" attachment_provider_source)
file(READ "${SOURCE_DIR}/apps/android/android/AndroidManifest.xml" android_manifest)
file(READ "${SOURCE_DIR}/apps/android/android/src/com/aimeetingtable/mobile/BoundedStreamCopier.java" stream_copier_source)
...
file(READ "${SOURCE_DIR}/apps/android/src/app/mobile_app_controller.cpp" controller_source)
file(READ "${SOURCE_DIR}/apps/android/src/app/mobile_app_controller.h" controller_header)
...
file(READ "${SOURCE_DIR}/apps/android/qml/Main.qml" main_qml_source)
...
file(READ "${SOURCE_DIR}/apps/windows/src/ui/main_window.cpp" windows_main_window_source)
file(READ "${SOURCE_DIR}/apps/windows/src/ui/dialogs/settings_dialog.cpp" windows_settings_source)
file(READ "${SOURCE_DIR}/apps/windows/src/ui/widgets/meeting_table_widget.cpp" windows_table_source)
require_absent("${windows_main_window_source}" "Total cost" "Windows monetary telemetry")
require_absent("${windows_settings_source}" "Max total cost" "Windows monetary limit")
require_absent("${windows_table_source}" "Cost: $" "Windows monetary seat telemetry")
